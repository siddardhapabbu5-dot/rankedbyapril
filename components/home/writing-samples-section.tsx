...
export function WritingSamplesSection() {
  return (
    <section
      id="writing-samples"
      className="scroll-mt-24 bg-white py-16 md:py-20 dark:bg-background"
    >
      <div className="container-page">
          ...
          {samples.map((sample) => (
            <StaggerItem key={sample.title}>
              ...
              >
                ...
                <h3 className="mt-4 font-display text-xl font-bold leading-snug text-brand-ink group-hover:text-brand-accent dark:text-white">
                  {sample.title}
                </h3>
                <p className="mt-3 flex-1 text-sm leading-relaxed text-brand-muted">
                  {sample.description}
                </p>
                <p className="mt-5 inline-flex items-center gap-1 text-xs font-semibold uppercase tracking-wide text-brand-muted">
        ...
        <div className="mt-14 border-t border-brand-ink/10 pt-10 dark:border-white/10">
          <FadeIn>
            ...
            <p className="mt-10 text-[11px] font-semibold uppercase tracking-[0.18em] text-brand-muted">
              My toolbox
            </p>
