...
/**
 * Server-rendered hero shell for fast LCP.
 * Portrait uses a pre-optimized static asset + preload (not /_next/image).
 */
          ...
          <div className="relative mx-auto w-full max-w-[380px]">
            <div className="relative overflow-hidden rounded-[1.75rem] border-[5px] border-white bg-white shadow-[0_25px_60px_-25px_rgba(24,35,58,0.4)] dark:border-white/10">
              <picture>
                ...
                {/* eslint-disable-next-line @next/next/no-img-element -- static LCP asset; avoid /_next/image latency */}
                <img
