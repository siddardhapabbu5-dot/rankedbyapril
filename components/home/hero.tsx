...
import { HeroLocalized, HeroRoleLocalized } from "@/components/home/hero-copy";

/**
 * Server-rendered English hero for fast LCP (CMS copy).
 * Visayan / Tagalog hydrate when the language switcher changes.
 */
