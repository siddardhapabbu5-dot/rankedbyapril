  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-brand-ink/15 bg-transparent text-brand-ink hover:border-brand-accent hover:text-brand-accent dark:border-white/20 dark:text-white dark:hover:border-brand-accent dark:hover:text-brand-accent",
        ghost:
